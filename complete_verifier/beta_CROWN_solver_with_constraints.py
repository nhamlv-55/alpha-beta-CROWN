...
class LiRPAConvNetPlus:
    """
    This is an extension of LiRPAConvNet, that supports additional constraints on the ReLUs
    ...
    def _init_result_lists(self, decision, history):
        ...
        ret_l = [[] for _ in range(n_fixed_relus + n_unstable_relus * 2 )]
        ret_u = [[] for _ in range(n_fixed_relus + n_unstable_relus * 2 )]
        ret_s = [[] for _ in range(n_fixed_relus + n_unstable_relus * 2 )]
        ret_b = [[] for _ in range(n_fixed_relus + n_unstable_relus * 2 )]
